...
from backend.database import get_db, Task, ScanReport, VideoAnnotation
...
from backend.task_restart import register_resumable
...
def run_subtitle_rename(
    ...
    from backend.database import SessionLocal
    from backend.api.medialibraries import trigger_refresh
