...
from backend.services.task_pubsub import TERMINAL_SENTINEL, get_pubsub
...
def update_task_progress(
    ...
    from backend.task_log_capture import attach as _log_attach, peek as _log_peek
    _log_attach(task_id)
...
def complete_task(
    ...
    from backend.task_log_capture import drain as _log_drain, detach as _log_detach
