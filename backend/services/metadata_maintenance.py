...
from backend.database import MediaMetadata, engine
...
class _MetadataRefreshWorker:
    ...
    def _refresh_tmdb(self, source_id: str, hint: dict):
        ...
        try:
            ...
            from backend.api.discover import _tmdb_scrape_lang
        ...
        try:
            from backend.api.discover import _normalize_detail, _upsert_tmdb_detail
    ...
    def _refresh_anilist(self, source_id: str):
        ...
        try:
            ...
            return
        try:
            from backend.api.discover import _upsert_anilist_detail
